...
static std::string coapServerResource = "/stock/reqHandler";
                                        ...
                                        OCClientResponse * clientResponse)
{
    ...
    if (clientResponse)
    {
        ...
        OIC_LOG_V(INFO, TAG, "Discovered on %s(%d)", connectionType.c_str(), clientResponse->connType);
        OIC_LOG_V(INFO, TAG,
        ...
        {
        	OIC_LOG_V (INFO, TAG, "Found %s in payload. Start Sending Post Request.", coapServerResource.c_str());
